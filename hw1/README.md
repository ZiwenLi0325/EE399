...
For part (ii), we sweep through values of two parameters while fixing the other two and generate a 2D loss landscape. We find multiple minima as we sweep through parameters, indicating the presence of multiple local minima. The approximation of each minima is shown in hw1.ipynb from figure 3 to 8. We can clearly view how minima are distributed with the blue wire or center in following graphs.
![figure2](figure3.SVG)
![figure2](figure4.SVG)
![figure2](figure5.SVG)
![figure2](figure6.SVG)
...
![figure2](figure9.SVG)
![figure2](figure10.SVG)
![figure2](figure11.SVG)
...
Comparing test data error for linear, parabola and 19th order polynomial, which are 3.36357454055256, 8.713788015520553 and 28617752784.428474 respectively for (iii) and 2.948744055799438, 2.935297745820336 and 81.93347036362427 respectively for (iv), we can notice that the errors are decreased when data are more boarderly spreaded.

![figure2](figure12.SVG)
![figure2](figure13.SVG)
![figure2](figure14.SVG)
